...
class Yarn:
    ...
    def __init__(self, request_timeout=10, logger=logging):
        ...
        yarn_resourcemanager_hosts = [host['HostRoles']['host_name'] for host in yarn_resourcemanager_ambari_info['host_components']]
    ...
    def check_yarn_resourcemanager_status(self):
        ...
        :return:
        """
        self.logger.debug("Checking YARN ResourceManager status. {0} known addresses.".format(len(self.yarn_resourcemanager_urls)))
