...
class MrSmokeTest(base.SmokeTest):
    def __init__(self, cmd_line_type='AMBARI'):
        super().__init__('MAPREDUCE2', 'HISTORYSERVER', logname='smoketest-mr.log', stop_type=cmd_line_type,
                         process_user='mapred', process_indicator='JobHistoryServer', stop_realization_timeout=15)
